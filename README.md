...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Diagrams/Elk%20stack%20Diagram.png)
```diff
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/ElkServerAutomation.png?raw=true)
...
```
   - [CLICK to view - Elk-Server-Deployment.yml](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/elk-server-deployment.yml)
```diff
...
change them.
```
   - [CLICK to view - Ansible.cfg](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/Ansible.cfg)
```diff
...
```
   - [CLICK to view - Ansible Hosts File](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/hosts)
```diff
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/PlaybookOutput.png)
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/ElkServerAutomation.png)
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/Kibana.png)
...
```
   - [CLICK to view - Filebeat-Configuration.yml](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/filebeat-configuration.yml)
   - [CLICK to view - Filebeat-Playbook.yml](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/filebeat-playbook.yml)
   - [CLICK to view - Metricbeat-Confgiuration.yml](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/metricbeat-configuration.yml)
   - [CLICK to view - Metricbeat-Playbook.yml](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/Ansible/metricbeat-playbook.yml)
```diff
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/filebeatinstall.png)
```diff
...
![alt text](https://github.com/BleepinNbloopin/Elk_Stack/blob/main/ScreenShots/Filebeat.png)
